package com.projeto_springboot.projeto_spring_boot.config;


import com.projeto_springboot.projeto_spring_boot.entites.*;
import com.projeto_springboot.projeto_spring_boot.enums.OrderStatus;
import com.projeto_springboot.projeto_spring_boot.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        OrderItem oi3 = new OrderItem(o3,p2,5, p2.getPrice());
        OrderItem oi4 = new OrderItem(o1,p4,2, p4.getPrice());
        OrderItem oi5 = new OrderItem(o2,p5,8, p5.getPrice());
